...
| Converter | `mef_converter/kmt_ceu_archon_mknt_to_l0_amp_mef_v2_1.py` (v2.1.2) |
| L1 전처리 파이프라인 | `mef_pipeline/kmt_ceu_preproc` (v1.3: electrons 단일 MEF, amp 경계 조화, astrometry+`WCSSOLVE` 플래그, VAR/MASK 옵션) |
