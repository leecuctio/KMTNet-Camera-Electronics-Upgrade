...
/*!
  \file client.h
  \brief TTYTool Application Header

  ISIS client application header for the ttytool application.
...
#define DEFAULT_MYID      "TTY"  //!< default client ISIS node name
#define DEFAULT_MYPORT    7101   //!< default client socket port   
#define DEFAULT_RCFILE    "/home/dts/Config/ttytool.ini" //!< default client runtime config file
#define DEFAULT_LOGFILE   "/home/dts/Logs/ttytool.log" //!< default client runtime log file (unimplemented)
...
#include "ttyutils.h"   // TTYUtils Serial I/O API header

extern ttyport_t commport;
