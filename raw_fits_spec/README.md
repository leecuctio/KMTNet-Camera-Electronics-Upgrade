...
| `KMTA.20260818.012345.MK.fits.header.v1.0.txt` | **확정 초안 헤더 v1.0** (운영자 승격 2026-08-22) — 검토 왕복(v0.0~v0.4.4)을 마친 raw MK 헤더 견본, 143카드. 구 `__review/` 왕복함은 폐지 — docx 왕복본·초안 이력은 운영자 외부 백업(`__backup_raw_fits_spec_oldver`)에 |
