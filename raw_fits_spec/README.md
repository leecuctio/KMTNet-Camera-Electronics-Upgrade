...
> ✅ **현행 규격: [`KMT_CEU_Raw_FITS_Specification_v1.5.md`](KMT_CEU_Raw_FITS_Specification_v1.5.md) — "raw spec"** (2026-08-25). 2026-08-18~22 전면 재검토(확인 요망 11건 전량 종결 · D-016 등재)의 재작성판(v1.3) → 운영자 1~4장 검토 반영(v1.4) → **v1.5 부터 5장(헤더 keyword) 검토분을 싣는다** (`Cn_*` 자리 순서 5.6.1절 · 견본 comment 오타 2건 정정). 구 "Raw FITS Pair 규격" v1.2 를 개명·대체한다(구판은 `archive/`).
>
...
| 구분 | 문서 | 버전 | 상태 |
| --- | --- | --- | --- |
| **Raw spec (현행)** | [`KMT_CEU_Raw_FITS_Specification_v1.5.md`](KMT_CEU_Raw_FITS_Specification_v1.5.md) | v1.5 | ✅ 현행 (1~4장 검토 반영 + 5장 검토 개시분) |
