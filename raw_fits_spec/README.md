...
| 구분 | 문서 | 버전 | 상태 |
| --- | --- | --- | --- |
| **Raw spec (현행)** | [`KMT_CEU_Raw_FITS_Specification_v1.10.md`](KMT_CEU_Raw_FITS_Specification_v1.10.md) | **v1.10** | ✅ 현행 (HK 카드 5장 신설 + 온도 부호 규약 + 게이지 Off 조항) |
...
| `header_samples/KMTA.20260821.123456.G.…v1.10.txt`<br>`…v1.10+LF.txt` | **guide 헤더 견본 v0.0 확정 초안** (운영자 2026-08-30) — 값 카드 **128장** + COMMENT 8 + END 1 + 공백 7 = **144 레코드**, 4×2880 = **11,520 바이트**. `+LF` 는 메모장용 사본(11,669 B — LF 와 꼬리 `#EOF` 를 걷어내면 정본과 동일). ⏳ 규격 10장과의 **대사 확인 목록은 `SMC_CLAUDE.md`** — 견본과 10장이 어긋나면 10장이 이긴다 |
