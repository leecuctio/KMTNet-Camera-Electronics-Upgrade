...
| 구분 | 문서 | 버전 | 상태 |
| --- | --- | --- | --- |
| **Raw spec (현행)** | [`KMT_CEU_Raw_FITS_Specification_v1.11.md`](KMT_CEU_Raw_FITS_Specification_v1.11.md) | **v1.11** | ✅ 현행 (v1.10 발행본과 내용이 갈려 판을 끊었다 — 내용 변경 없음) |
| 카드 판정 원장 | [`KMT_CEU_Raw_FITS_Header_and_Refs_in_MEF_Converter_v1.17.md`](KMT_CEU_Raw_FITS_Header_and_Refs_in_MEF_Converter_v1.17.md) | **v1.17** | ✅ 현행 (raw spec v1.10 동반) |
...
| `header_samples/KMTA.20260821.123456.G.…v1.11.txt`<br>`…v1.11+LF.txt` | **guide 헤더 견본 v0.0 확정 초안** (운영자 2026-08-30) — 값 카드 **128장** + COMMENT 8 + END 1 + 공백 7 = **144 레코드**, 4×2880 = **11,520 바이트**. `+LF` 는 메모장용 사본(11,669 B — LF 와 꼬리 `#EOF` 를 걷어내면 정본과 동일). ⏳ 규격 10장과의 **대사 확인 목록은 `SMC_CLAUDE.md`** — 견본과 10장이 어긋나면 10장이 이긴다 |
