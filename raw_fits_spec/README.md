...
| 기준 converter | `../mef_converter/kmt_ceu_archon_mknt_to_l0_amp_mef_v2_1.py` (v2.1.3) |
...
| 파일 | 원본 위치 | 비고 |
| --- | --- | --- |
| `KMT_CEU_Science_MEF_ICD_L0AmpRaw_v4.0.docx` | `../mef_fits_spec/` | L0 MEF ICD v4.0 |
| `KMT_CEU_Science_MEF_ICD_L0AmpRaw_v4_0_KO.docx` | — | 위 ICD의 국문본. **이 디렉토리가 유일본** |
