...
**v0.9 (Draft)** · 2026-09-04 · **HK 카드 5장 신설 반영** (raw spec v1.10 동반) — ⏳ **본문 반영 진행 중**: HK C-항목에 히터 넷 등재와 *"converter 가 안 읽는 신설 카드"* 대응 행이 아직 들어가지 않았다.  판 선언만 먼저 올린 상태다 · 구판 v0.8 = 2026-08-30 · 구판 v0.7 = 2026-08-29 · **Part 1** = 헤더 카드 개정이 MEF 쪽 3자(ICD v4.1 · MEF keyword 정의서 v1.0 · converter v2.2.0)에 요구하는 개정 목록 · **Part 2** = raw 파일 번호 · 정체성 · 충돌 처리 재설계와 그 MEF 파급
