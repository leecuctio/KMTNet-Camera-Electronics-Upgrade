...
**v1.17** · 개정 2026-09-04 · **HK 카드 5장 신설 반영** (raw spec v1.10 동반) — ⏳ **본문 반영 진행 중**: 7장 카드 표에 `HKUDATE`·`HTREN`·`HTRSET`·`HTROUT`·`HTRFORCE` 5행과 공급 계통 문장(둘 → **셋**, `ICG heater` 신설)이 아직 들어가지 않았다. 판 선언만 먼저 올린 상태다.
