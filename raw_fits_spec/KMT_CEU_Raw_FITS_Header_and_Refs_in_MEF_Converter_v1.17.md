...
**v1.17** · 개정 2026-09-04 · **HK 카드 5장 신설 반영** (raw spec v1.10 동반) — 7장 카드 표에 `HKUDATE`·`HTREN`·`HTRSET`·`HTROUT`·`HTRFORCE` **5행 추가**(카드 63→68장 · 표 55→60행), 3.7절 HK 공급 계통을 **둘 → 셋**으로(`ICG heater` 신설, 되읽기/실측 두 층).
