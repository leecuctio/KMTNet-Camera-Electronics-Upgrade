...
## ✅ 현행 규격 — raw spec v1.9 (2026-08-30, 라운드 열림)
...
- ⭐ **v1.9 발행분 (2026-08-30, 커밋 `cf89057` — 목 검토 대기 · 태그 전 · 미푸시)** — 세 문서를 함께 판올림했다: **규격 v1.8 → v1.9** · **원장 v1.15 → v1.16** · **통합문서 v0.7 → v0.8** (구판 `archive/`). 태그 `raw-spec-v1.9` 는 관례대로 **라운드가 닫힐 때(견본 v1.1 승격 후) 마지막 커밋에** 붙인다.
