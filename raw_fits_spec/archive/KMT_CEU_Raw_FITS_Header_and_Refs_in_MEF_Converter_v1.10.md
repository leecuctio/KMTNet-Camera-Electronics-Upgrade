...
**v1.10** · 개정 2026-08-22 · 운영자 4차 개정(v1.9_revision.docx) 반영
...
- **v1.10 으로 도입 판정이 완결됐다** — 3장·6장 계획 열과 7장 도입 여부에 **빈칸이 없다**. 남은 쟁점은 판정이 아니라 **확인 요망 11건**(특히 PRESCN 삼자 모순·규격 버전 선언 공백)과 **D-등재**다.
