...
최종 갱신일: 2026-09-15 (CTIO/SAAO 출장 일정 변경)
...
| M14 | SAAO Upgrade | 2026-12-06 to 2026-12-21 | 전체 | 최종 사이트, 온스카이 (2026-09-15: 온스카이 4박, 복귀 하루 연장) |
...
| 12-14 | 월 | 온스카이 시험관측 | 온스카이 1/4 |
| 12-15 | 화 | 온스카이 시험관측 | 온스카이 2/4 |
| 12-16 | 수 | 온스카이 시험관측 | 온스카이 3/4 |
| 12-17 | 목 | 온스카이 시험관측 | 온스카이 4/4 |
| 12-18 | 금 | 마무리, 김재우 영상 검토 요청 | acceptance 판정 |
| 12-19 | 토 | 서덜랜드 출발 (영상 정상 시) | 비정상 시 일정 연장 |
| 12-20~21 | 일~월 | 두바이 경유 → 한국 도착 | 이동 |

- 온스카이 시험관측을 12-14~17 **4박**으로 수행(칠레보다 날씨 불리하여 날씨 대비 — 2026-09-15 3박→4박 연장, 복귀 하루 연장 12-20→12-21). 12-18 김재우 영상검토 → **정상=12-19 출발, 비정상=일정 연장**. 주말 휴식 없이 연속 작업.
...
- HE박스/월보드 교체, 진공/냉각이 정상이다.
- Bias, Dark, FITS, readout, data transfer가 정상 동작한다.
- 온스카이 시험관측(4박) 영상을 확보하고 김재우 영상 검토(정상 판정)를 통과한다.
