...
| 2 | CTIO | Second Site | 2026-11-12 to 2026-11-26 | SSO 교훈 반영 + 첫 온스카이 commissioning |
| 3 | SAAO | Final Site | 2026-12-06 to 2026-12-20 | 최종 사이트 적용, 온스카이 + closeout 준비 |
...
| M13 | CTIO Upgrade | 2026-11-12 to 2026-11-26 | 전체 | SSO 교훈 반영, 첫 온스카이 |
| M14 | SAAO Upgrade | 2026-12-06 to 2026-12-20 | 전체 | 최종 사이트, 온스카이 |
...
역할: Second Site  
목표 일정: 2026-11-12 to 2026-11-26
...
| 날짜 | 요일 | 작업 | 비고 |
| --- | --- | --- | --- |
| 11-12 | 목 | 한국 출발 (파리 경유 → 칠레) | 이동 |
| 11-13 | 금 | 냉각기 off | 현지 관측자가 사전 요청대로 실행 (이동 중) |
| 11-14 | 토 | 오전 도착 → 클린부스 제작 / 카메라 제거 / HE박스 제거 | 다인원 분담 병행 |
| 11-15 | 일 | HE박스 교체 / 월보드 교체 후 진공펌핑 | 핵심 작업 |
| 11-16 | 월 | HE박스 설치 / 카메라 설치 후 냉각 | |
| 11-17 | 화 | 시험관측 | |
| 11-18 | 수 | 영상확인 / 캘리브레이션 / 시험관측 | |
| 11-19 | 목 | 온스카이 시험관측 | 온스카이 1/4 |
| 11-20 | 금 | 온스카이 시험관측 | 온스카이 2/4 |
| 11-21 | 토 | 온스카이 시험관측 | 온스카이 3/4 |
| 11-22 | 일 | 온스카이 시험관측 + 마무리, 김재우 영상 검토 요청 | 온스카이 4/4, acceptance 판정 |
| 11-23 | 월 | 천문대 출발 (영상 정상 시) | 비정상 시 일정 연장 |
| 11-24~26 | 화~목 | 산티아고 → 파리 → 한국 도착 | 이동 |

- 온스카이 시험관측을 11-19~22 **4박**으로 수행(첫 온스카이 commissioning, 데이터·날씨 여유 확보). 11-22 마무리 시 김재우 영상 검토 → **정상이면 11-23 예정대로 출발, 비정상이면 출장 일정을 연장하여 문제 해결**. 도착일(11-14)은 다인원이 작업을 분담해 병행한다. 주말 휴식 없이 연속 작업.
...
역할: Final Site  
목표 일정: 2026-12-06 to 2026-12-20
...
| 12-19~20 | 토~일 | 두바이 경유 → 한국 도착 | 이동 |

- 온스카이 시험관측을 12-14~16 **3박**으로 수행(칠레보다 날씨 불리하여 날씨 대비). 12-17 김재우 영상검토 → **정상=12-18 출발, 비정상=일정 연장**. 주말 휴식 없이 연속 작업.
...
- HE박스/월보드 교체, 진공/냉각이 정상이다.
- Bias, Dark, FITS, readout, data transfer가 정상 동작한다.
- 온스카이 시험관측 영상을 확보하고 김재우 영상 검토(정상 판정)를 통과한다.
