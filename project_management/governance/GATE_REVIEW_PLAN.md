...
- [ ] 현재 일정 및 milestone 상태
- [ ] open P0/P1 backlog 항목
- [ ] action register overdue 항목
- [ ] risk register와 mitigation 상태
- [ ] configuration baseline 또는 변경 내역
- [ ] science verification result 또는 preview
- [ ] logistics/site readiness 상태
- [ ] decision: Go, Conditional Go, No-Go

## Decision Record

| Date | Gate | Decision | Conditions | Approver | Follow-up |
| --- | --- | --- | --- | --- | --- |
| TBD | Gate 1 | TBD | TBD | 이충욱 | TBD |
| TBD | Gate 2 | TBD | TBD | 이충욱 | TBD |
| TBD | Gate 3 | TBD | TBD | 이충욱, 김재우 | TBD |
| TBD | Gate 4 | TBD | TBD | 이충욱 | TBD |
