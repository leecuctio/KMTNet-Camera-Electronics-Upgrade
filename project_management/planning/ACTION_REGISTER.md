...
| ACT-007 | 2026-08-13 | Site | SSO Wallboard 교체 전문가 Tom O'Brien 방문용역 협의·계약 | 이충욱 | 2026-09 | In Progress | 일정(10-18~11-01)·지원조건(항공/일비/자문료) 제안 발송, Tom 검토·회신 대기 중 — **2026-08-23 기준 협의 계속**. 서면 자문은 Greg 참여 확정으로 보완 (TEAM_ROLES 외부 협력 표). 자문 질문 목록 준비 완료: `sites/SSO/TOM_CONSULTATION_QUESTIONS.md` (서면 5 + 현장 21) |
