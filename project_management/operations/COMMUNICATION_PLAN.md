...
| Site Daily Briefing | During site work | 현장 참여자 | 당일 작업계획 및 안전 확인 | site work log |

## 회의 기록 원칙

- 결정 사항은 `governance/DECISION_LOG.md`에 남긴다.
- 담당자와 due date가 생긴 항목은 `planning/ACTION_REGISTER.md`에 남긴다.
- 배송/장비 이슈는 `logistics/EQUIPMENT_TRACKER.md`에 남긴다.
- 현장 이슈는 각 site의 `SITE_PLAN.md`와 site report에 반영한다.
