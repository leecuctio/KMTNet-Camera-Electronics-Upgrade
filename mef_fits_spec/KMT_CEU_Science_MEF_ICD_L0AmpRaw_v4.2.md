...
**v4.2 | 2026-09-04** (v4.1: 2026-08-10 · v4.0: 2026-06-19)

> 이 md 파일은 `KMT_CEU_Science_MEF_ICD_L0AmpRaw_v4.2.docx`와 동일 내용의 diff 가능한 기준본이다. 둘은 항상 같은 개정으로 갱신한다.
...
- The filename `<SITE>` must agree with the `OBSERVAT` header; the converter (v2.4.0) derives the output MEF prefix from the filename site code and raises an error on mismatch.
