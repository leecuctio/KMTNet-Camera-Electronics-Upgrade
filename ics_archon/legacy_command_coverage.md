...
| **C1HKDATA / C2HKDATA** | ICS·ICG (ICG 는 `C1HKDATA` 만) | `CnHKDATA [NOW]` | 컨트롤러 텔레메트리 한 줄 — 헤더 `Cn_TEMP/VOLT/CURR` 의 와이어 판, `CnSTALE`·`CTRLnID` 동반 | 신설 — 운영자 확정 2026-09-04, 구현 2026-09-15 (`hkwire.ctrl_hkdata_body` 를 ICS·ICG 가 같이 쓴다) |
