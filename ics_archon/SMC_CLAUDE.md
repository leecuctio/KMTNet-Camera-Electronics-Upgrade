...
| 시험 | `ics_archon` **636** · `ics_sim` **370** — **전수 통과** (2026-09-09 실측, deselect 없음).  ⛔ **알려진 flake 는 없다** — 종전 표의 *"flake 1 deselect"* 는 둘 다 사실이 아니었고(회귀였다, `8664e92` 에서 고쳤다 · 오기 철회 `086bb4e`), `deselect` 장치는 저장소에 없다 |
...
### ⭐⭐ 2026-09-07~09 추가분 (DevNote 11.39~11.50) — **이것이 최신**
