...
| 시험 | `ics_archon` **656** · `ics_sim` **391** — **전수 통과** (2026-09-09 저녁 실측, deselect 없음).  ⛔ **알려진 flake 는 없다** — 종전 표의 *"flake 1 deselect"* 는 둘 다 사실이 아니었고(회귀였다, `8664e92` 에서 고쳤다 · 오기 철회 `086bb4e`), `deselect` 장치는 저장소에 없다 |
...
### ⭐⭐ 2026-09-09 저녁 추가분 (DevNote 11.57) — **이것이 최신**
