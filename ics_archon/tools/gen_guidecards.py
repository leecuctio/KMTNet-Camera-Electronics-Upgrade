...
정본: `raw_fits_spec/header_samples/KMTA.20260821.123456.G.fits.header.v1.11.txt`
(raw spec v1.11 10장 -- 값 카드 128 + COMMENT 8 + END 1 + 공백 7 = 144 레코드).
"""
...
SAMPLE = os.path.join(REPO, 'raw_fits_spec',
                      'header_samples',
                      'KMTA.20260821.123456.G.fits.header.v1.11.txt')
