...
옮기기 쉽고, 아래 규칙에는 실제로 밟기 쉬운 함정이 셋 있다.
    ...
    python tools/extract_timing_script.py acf/KMTK_GUI_162_STA0201_R2618.acf
...
#: 24장에 **1,834개**나 더 있다 -- `TAPLINE<n>=` 502 · `MOD<n>\\VCPU_LINE<n>=`
#: 1,332 (MKS 356 진공게이지 VCPU 프로그램.  `icg_archon/hk.py` 의
...
def extract(path: str) -> tuple[str, int | None, int | None]:
    ...
    guide R2618 · science R2611 기준; guide 는 R2613~R2616 이 120, 그 전이 113,
