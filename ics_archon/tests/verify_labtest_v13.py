# -*- coding: utf-8 -*-
"""scr_labtest/archon_kmtnet_labtest_v1.3.bigbuf.py 회귀 검증 -- 실기 없이 돌린다.

    python tests/verify_labtest_v13.py      # 0 = 전부 통과, 1 = 실패 있음
...
SRC = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                   os.pardir, 'scr_labtest', 'archon_kmtnet_labtest_v1.3.bigbuf.py')
