...
UNIT_CTRL_ID = 'KMTS-SCI-101'   #  <---- Set this: FITS CTRL1ID (예 KMTA-SCI-101)
UNIT_CTRL_SN = 'STA-0286'       #  <---- Set this: FITS CTRL1SN (seril number on real pannel lable)
...
UNIT_ACF_SCI_NORMAL = '../Config/acf/KMTS_SCI_101_STA0286_R2608_MK.acf'
...
GetDataset(UNIT_ACF_SCI_NORMAL, False, False, 2864, 8, DATA_STORAGE)
