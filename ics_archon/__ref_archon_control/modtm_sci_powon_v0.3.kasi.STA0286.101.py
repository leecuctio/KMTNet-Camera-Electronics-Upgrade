#### archon_kmtnet_stascience_powon_v0.3.kasi.STA0286.101.py / 2026-05-31
#### - original version: archon_kmtnet_stascience_modtm_v0.3.kasi.STA0286.101.py / 2026-05-29
...
UNIT_IPADDR = '10.0.0.101'
UNIT_ACF = 'acf/kmtnet_stascience_STA0286_101_R2601.acf'
...
PathLog = "%s/modtm.sci.101.log" % DIR_LOG
DirFits = "%s/fits.sci.101" % DIR_LOG
DATA_PREFIX = "sci.101"
