...
| ACF 경로 | `[icg] acf` | `acf/KMTK_GUI_162_STA0201_R2619.acf`.  ⚠️ **유일본이 아니다** — 2026-09-11 반입으로 guide ACF 가 넉 장이고 (CTIO `STA0290` · SAAO `STA0291` · KASI `STA0201`·`STA0230`), KASI 두 상자는 **같은 `.162`** 를 쓴다.  벤치에 놓인 상자의 `BACKPLANE_ID` 를 보고 고를 것 |
