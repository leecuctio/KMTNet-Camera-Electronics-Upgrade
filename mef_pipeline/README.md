...
설계 문서: [`KMT_CEU_L1_Preproc_Pipeline_Design_v1.1.md`](KMT_CEU_L1_Preproc_Pipeline_Design_v1.1.md)

## 현재 기준선

| 구분 | 값 |
| --- | --- |
| 파이프라인 | `kmt_ceu_preproc` v1.1 (순수 Python + NumPy + astropy) |
...
| 문서 | 위치 |
| --- | --- |
| 설계 문서 | `KMT_CEU_L1_Preproc_Pipeline_Design_v1.1.md` |
