...
2. **`ics_archon` 구현** — Archon 컨트롤러 2기 제어 + raw FITS pair 저장. 제어 시퀀스의 원형은 [`../ics_archon/archon_kmtnet_labtest_v1.1.bigbuf.py`](../ics_archon/README.md) (raw spec v1.3 적용판, 2026-08-22), **저장 규격은 [`../raw_fits_spec/`](../raw_fits_spec/README.md)** — 저장/통보 단위가 갈라지는 지점(D-009/D-010)은 DevNote 9.1 의 상기 블록에 정리돼 있다.
