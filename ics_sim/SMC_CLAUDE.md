...
- **IC(VDOS) 본체 소스는 백업에 없다** — 오염 버그의 코드 위치는 여전히 미확인. 다만 **디스크 이미지는 있다**: `__localonly_osc_legacy/IC2_KX20160323.1381_ICSci_{CTIO,SAAO}/IC2.img` (각 8 GB, 비커밋). 마운트해 `\KMTX` 를 꺼내면 문자열·포맷 추출까지는 가능하다.
