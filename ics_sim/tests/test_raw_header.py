...
규격: 현행 raw spec(`raw_fits_spec/KMT_CEU_Raw_FITS_Specification_v<판>.md`) 4·5장.
...
OBSDATE_CASES = [
    ...
    # KASI 는 KST 자정 경계 (UT 15:00) -- 더하면 곧 한국 날짜다.
    ('KMTK', '00:00', '20260813'), ('KMTK', '14:59', '20260813'),
    ('KMTK', '15:00', '20260814'), ('KMTK', '23:59', '20260814'),
]
