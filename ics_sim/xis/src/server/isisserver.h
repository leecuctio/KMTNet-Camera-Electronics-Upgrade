...
// 2003 January 20
//
// Last modification: 2014 Oct 13 [rwp/osu]
//    increased MAXCLIENTS to 64
//    increased MAXPRESET to 32 
//    increased MAXSERIAL to 16
// this is headroom for KMT Camera testing (kind of overkill)
//
...
#define MAXSERIAL 16  //!< maximum number of serial port connections 
...
/*!
  ...
  2014 Oct 21 - added the port speed to the struct [rwp/osu]
*/

extern struct serial {
  char devName[MED_STR_SIZE];  //!< Serial port physical device name
  int  fd;                     //!< Serial port file descriptor
  int  speed;                  //!< Serial port speed [default: 9600 Baud]
} ttyTab[MAXSERIAL];
...
#define MAXPRESET  32  //!< Maximum number of preset UDP ports
